        ...
        if (item.getItemId() == R.id.tweet) {
            ...
            builder.setPositiveButton("Send", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Log.i("Tweet", tweetContentEditText.getText().toString());
                    ...
                    tweet.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e == null) {
                                ...
                                Toast.makeText(UserListActivity.this, "Unable to send tweet. Please try again later.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (checkedTextView.isChecked()) {
                    Log.i("UserList", position + " Row is checked");

                    ParseUser.getCurrentUser().getList("isFollowing").add(users.get(position));
                    ParseUser.getCurrentUser().saveInBackground();
                } else {
                    Log.i("UserList", position + " Row is not checked");
